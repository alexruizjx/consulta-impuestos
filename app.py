            ...
            json={
                ...
                "messages": [{
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": "Eres un experto en leer tarjetas de propiedad de vehiculos colombianos. La imagen puede estar en cualquier orientacion (vertical, horizontal, girada). Analiza TODOS los caracteres con mucho cuidado, especialmente los numeros. Extrae: 1. PLACA (exactamente 3 letras + 3 numeros, verifica cada caracter) 2. MODELO (año 4 digitos) 3. MUNICIPIO de transito 4. CEDULA o IDENTIFICACION del propietario (verifica TODOS los digitos uno por uno, no omitas ninguno) 5. APELLIDOS del propietario. Responde SOLO en JSON: {\"placa\": \"\", \"modelo\": \"\", \"municipio\": \"\", \"cedula\": \"\", \"apellidos\": \"\"}. Municipios validos: ANDES, APARTADO, BARBOSA, BELLO, CALDAS, CAREPA, EL CARMEN DE VIBORAL, CAUCASIA, CIUDAD BOLIVAR, COPACABANA, DEPARTAMENTAL, ENVIGADO, FRONTINO, GIRARDOTA, ITAGUI, LA CEJA, LA ESTRELLA, LA UNION, MARINILLA, MEDELLIN, PUERTO BERRIO, RIONEGRO, SABANETA, SANTA FE DE ANTIOQUIA, SANTA ROSA DE OSOS, SONSON, TURBO, URRAO, YARUMAL"
                        }
                    ]
                }]
            },
