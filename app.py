...
def ocr_runt_texto():
    try:
        ...
        prompt = (
            ...
            "propietario 12. MUNICIPIO: suele aparecer en un campo llamado 'Organismo de Transito' u "
            "'Organismo de Transito Matricula', casi siempre ABREVIADO de forma variable, por ejemplo "
            ...
            "Extrae SOLAMENTE el nombre del municipio (la ultima palabra o palabras), sin ninguna de las "
            "siglas ni abreviaturas que la preceden (nunca dejes 'STRIA', 'TTEYTTO', 'SRIA', 'SECRETARIA' "
            "ni similares como parte del valor). Si no aparece ese dato en el texto, deja el campo vacio, "
            "no lo inventes. 13. LIMITACION_PROPIEDAD (gravamenes, prenda a favor de alguna entidad, o "
