...
def ocr_runt_texto():
    try:
        ...
        prompt = (
            ...
            "a favor de alguna entidad, o 'NINGUNA' si no tiene). Puede venir en dos formatos: (a) un "
            "campo 'Limitacion a la Propiedad' — si aparece con una serie de asteriscos como '******', "
            "eso significa 'NINGUNA' (nunca copies los asteriscos tal cual); si aparece el nombre de una "
            "persona o entidad, copia ese valor tal cual (tiene gravamen). (b) un campo 'Gravamenes a la "
            "Propiedad' con respuesta directa SI o NO — si dice SI responde 'SI' (tiene gravamen), si "
            "dice NO responde 'NINGUNA' (no tiene gravamen). Si un dato no aparece en el texto, "
